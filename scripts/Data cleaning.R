...
setwd("C:/Users/Daniel/Documents/Big  data/Taller 3")
...
train_personas <- read_csv("train_personas.csv")
...
train_personas <- train_personas %>% mutate_at(.vars= c("Clase", "Dominio", "Estrato1", "P6020",
                                                        "P6050", "P6090", "P6100", "P6210", "P6240", "Oficio",
                                                        "P6430", "P6510", "P6510s2", "P6545", "P6545s2", "P6580",
                                                        "P6580s2", "P6585s1", "P6585s1a2", "P6585s2", "P6585s2a2",
                                                        "P6585s3", "P6585s3a2", "P6585s4", "P6585s4a2", "P6590",
                                                        ...
                                                        "P7350","P7422","P7472","P7495","P7500s1","P7500s2","P7500s3",
                                                        "P7505","P7510s1","P7510s2","P7510s3", "P7510s5","P7510s6","P7510s7",
                                                        "Pet", "Oc", "Des", "Ina"),.funs = factor)

test_personas <- test_personas %>% mutate_at(.vars = c("Clase", "Dominio", "Clase", 
                                                       "Dominio", "P6020","P6050", "P6090", "P6100",
                                                       "P6210", "P6240", "Oficio","P6430", "P6510",
                                                       "P6545", "P6580","P6585s1", "P6585s2", "P6585s3", 
                                                       "P6585s4", "P6590","P6600", "P6610", "P6620", "P6630s1",
                                                       "P6630s4","P6630s2","P6630s3","P6870", "P6920", "P7040",
...
train_hogares <- train_hogares %>% mutate_at(.vars= c("Clase", "Dominio","P5000", "P5010", 
                                                      "Pobre", "Indigente", "P5090", "Npobres", 
                                                      "Nindigentes", "Depto"),.funs = factor)

test_hogares <- test_hogares %>% mutate_at(.vars = c("Clase", "Dominio","P5000", "P5010",
                                                     "P5090", "Depto"),.funs = factor)
...
df_test<-data_frame(id,Mujer_test,jefehogar_test)
...
#3. DEPURACIÓN DE LA BASE DE DATOS TRAIN
